...
with bot2:
    bot2.loop.run_until_complete(main2())
...
with bot3:
    bot3.loop.run_until_complete(main3())
...
with bot5:
    bot5.loop.run_until_complete(main5())
...
with bot6:
    bot6.loop.run_until_complete(main6())
...
with bot7:
    bot7.loop.run_until_complete(main7())
...
with bot8:
    bot8.loop.run_until_complete(main8())
